...
import mayankimg from "../../assets/teammemberone.png"
...
export function Teamdetails() {
    ...
    useEffect(() => {
        ...
        const initApplication = async () => {
            ...
            const slides = [
                { title: "Mayank Singh", description: "Frontend developer.", media: mayankimg },
                { title: "Vanshika Dixit", description: "Lost in a desert of blooming dreams and endless horizons.", media: "https://assets.codepen.io/7558/orange-portrait-002.jpg" },
                { title: "Harleen Kaur", description: "Wrapped in the deep, luxurious embrace of the night.", media: "https://assets.codepen.io/7558/orange-portrait-003.jpg" },
            ];
        ...
        `;
            ...
            const initRenderer = async () => {
                ...
                for (const s of slides) {
                    try {
                        const mediaSrc =
                            typeof s.media === "string" ? s.media : s.media.src;

                        slideTextures.push(await loadImageTexture(mediaSrc));
                    } catch {
    ...
    return (
        <>
            <style jsx global>{`
        body { margin: 0; padding: 0; overflow: hidden; font-family: 'Helvetica Neue', sans-serif; }
        ...
        /* The Canvas (Background) - Z-index 1 */
        .webgl-canvas {
            position: absolute;
            top: 0;
            left: 0;
        ...
        .slide-content {
            ...
            text-align: center;
            color: white;
            pointer-events: none; /* Let clicks pass through to background/nav if needed */
            width: 80%;
            max-width: 800px;
            mix-blend-mode: overlay; /* Optional: Looks cool over glass effect */
        }
        ...
        .slide-number { top: 40px; left: 60px; }
        .slide-total { top: 40px; right: 60px; opacity: 0.5; }
